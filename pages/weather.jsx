  ...
  return (
    <div className="w-full pt-[77px] dark:bg-black">
      ...
      <div className="m-auto bg-white dark:bg-black">
        <p className="mx-4 bg-gradient-to-tr from-orange-400 via-slate-800 to-amber-200 bg-clip-text px-7 pt-9 pb-5 text-[48px] sm:text-[56px] font-semibold text-transparent sm:mx-5 md:mx-7 lg:mx-9">
          Weather
        </p>
