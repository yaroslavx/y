  ...
  return (
    <div className="w-full pt-[77px] pb-[222px] dark:bg-black">
      ...
      <div className="m-auto bg-white dark:bg-black">
        <p className="mx-4 bg-gradient-to-tr from-orange-400 via-slate-800 to-amber-200 bg-clip-text px-7 pt-9 pb-5 text-[48px] font-semibold text-transparent sm:mx-5 sm:text-[56px] md:mx-7 lg:mx-9">
          Weather
        </p>
        <div className=" mx-4 grid gap-4 sm:mx-5 sm:gap-5 md:mx-7  md:grid-cols-5 md:gap-7 lg:mx-9 lg:gap-9">
          <div className="col-span-4 md:col-span-3">
            <div
              style={{
                background:
                  "conic-gradient(at left top, rgb(251, 146, 60), rgb(30, 41, 59), rgb(253, 230, 138))",
              }}
              className="relative h-full rounded-3xl  px-7 py-9  dark:bg-black "
            >
          ...
          <div className="col-span-4 md:col-span-2">
            ...
            <div className="mt-4 sm:mt-5 md:mt-7 lg:mt-9  h-fit rounded-3xl bg-[#f4f4f4] dark:bg-[#151516]">
              <div className="px-7 py-9">
                ...
                <div className="flex">
                  <p className="flex text-[19px] font-medium text-black/70 dark:text-white/70">
                  Search functionality, Fetch data
                  </p>
                </div>
              </div>
            </div>
